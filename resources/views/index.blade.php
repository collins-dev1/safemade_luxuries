        	...
        	<div class="home-slideshow">
            	<div class="slide">
                	<div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="{{asset('landing/assets/images/banner4.jpg')}}" src="{{asset('landing/assets/images/banner5.jpg')}}" alt="Shop Our New Collection" title="Shop Our New Collection" />
                ...
                <div class="slide">
                	<div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="{{asset('landing/assets/images/banner5.jpg')}}" src="{{asset('landing/assets/images/banner5.jpg')}}" alt="Summer Bikini Collection" title="Summer Bikini Collection" />
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
                                    <h2 class="h1 mega-title slideshow__title">Selfmade Luxuries</h2>
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="{{asset('landing/assets/images/product-images/product-image1.jpg')}}" src="{{asset('landing/assets/images/product-images/product-image1.jpg')}}" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="{{asset('landing/assets/images/product-images/product-image1-1.jpg')}}" src="{{asset('landing/assets/images/product-images/product-image1-1.jpg')}}" alt="image" title="product">
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <!-- Variant -->
                                                <ul class="swatches">
                                                    <li class="swatch medium rounded"><img src="{{asset('landing/assets/images/product-images/variant1.jpg')}}" alt="image" /></li>
                                                    <li class="swatch medium rounded"><img src="{{asset('landing/assets/images/product-images/variant2.jpg')}}" alt="image" /></li>
                                                    <li class="swatch medium rounded"><img src="{{asset('landing/assets/images/product-images/variant3.jpg')}}" alt="image" /></li>
                                                    <li class="swatch medium rounded"><img src="{{asset('landing/assets/images/product-images/variant4.jpg')}}" alt="image" /></li>
                                                    <li class="swatch medium rounded"><img src="{{asset('landing/assets/images/product-images/variant5.jpg')}}" alt="image" /></li>
                                                    <li class="swatch medium rounded"><img src="{{asset('landing/assets/images/product-images/variant6.jpg')}}" alt="image" /></li>
                                                </ul>
                                                <!-- End Variant -->
                                            </div>
                                            <!-- End product details -->
                                    ...
                                    <div class="productSlider">
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="{{asset('landing/assets/images/product-images/product-image6.jpg')}}" src="{{asset('landing/assets/images/product-images/product-image6.jpg')}}" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="{{asset('landing/assets/images/product-images/product-image6-1.jpg')}}" src="{{asset('landing/assets/images/product-images/product-image6-1.jpg')}}" alt="image" title="product">
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                                    <div class="product-labels rectangular"><span class="lbl on-sale">-16%</span> <span class="lbl pr-label1">new</span></div>
                                                    <!-- End product label -->
                                    ...
                                    <div class="productSlider">
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="{{asset('landing/assets/images/product-images/product-image11.jpg')}}" src="{{asset('landing/assets/images/product-images/product-image11.jpg')}}" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="{{asset('landing/assets/images/product-images/product-image11-1.jpg')}}" src="{{asset('landing/assets/images/product-images/product-image11-1.jpg')}}" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
				...
				<div class="collection-grid">
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="{{asset('landing/assets/images/collection/fashion.jpg')}}" src="{{asset('landing/assets/images/collection/fashion.jpg')}}" alt="Fashion" class="blur-up lazyload"/>
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img class="blur-up lazyload" data-src="{{asset('landing/assets/images/collection/cosmetic.jpg')}}" src="{{asset('landing/assets/images/collection/cosmetic.jpg')}}" alt="Cosmetic"/>
                                <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item blur-up lazyloaded">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="{{asset('landing/assets/images/collection/bag.jpg')}}" src="{{asset('landing/assets/images/collection/bag.jpg')}}" alt="Bag" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="{{asset('landing/assets/images/collection/accessories.jpg')}}" src="{{asset('landing/assets/images/collection/accessories.jpg')}}" alt="Accessories" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="{{asset('landing/assets/images/collection/shoes.jpg')}}" src="{{asset('landing/assets/images/collection/shoes.jpg')}}" alt="Shoes" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="{{asset('landing/assets/images/collection/jewellry.jpg')}}" src="{{asset('landing/assets/images/collection/jewellry.jpg')}}" alt="Jewellry" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
        	...
        	<div class="container">
            	<div class="row">
                    ...
                    <div class="logo-bar__item">
                        <img src="{{asset('landing/assets/images/logo/brandlogo1.png')}}" alt="" title="" />
                    </div>
                    <div class="logo-bar__item">
                        <img src="{{asset('landing/assets/images/logo/brandlogo2.png')}}" alt="" title="" />
                    </div>
                    <div class="logo-bar__item">
                        <img src="{{asset('landing/assets/images/logo/brandlogo3.png')}}" alt="" title="" />
                    </div>
                    <div class="logo-bar__item">
                        <img src="{{asset('landing/assets/images/logo/brandlogo4.png')}}" alt="" title="" />
                    </div>
                    <div class="logo-bar__item">
                        <img src="{{asset('landing/assets/images/logo/brandlogo5.png')}}" alt="" title="" />
                    </div>
                    <div class="logo-bar__item">
                        <img src="{{asset('landing/assets/images/logo/brandlogo6.png')}}" alt="" title="" />
                    </div>
                </div>
                	</div>
                </div>
                	...
                	<div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    	<div class="wrap-blog">
                        	<a href="blog-left-sidebar.html" class="article__grid-image">
              					<img src="{{asset('landing/assets/images/blog/post-img1.jpg')}}" alt="It's all about how you wear" title="It's all about how you wear" class="blur-up lazyloaded"/>
				            </a>
	...
	<div class="newsletter-wrap" id="popup-container">
      <div id="popup-window">
        ...
        <div class="display-table splash-bg">
          <div class="display-table-cell width40"><img src="{{asset('landing/assets/images/banner1.jpg')}}" alt="Join Our Mailing List" title="Join Our Mailing List" /> </div>
