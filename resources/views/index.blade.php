                                                ...
                                                <div class="product-image">
                                                    ...
                                                    <a href="short-description.html">
                                                        ...
                                                        <img class="primary blur-up lazyload"
                                                            data-src="{{ asset('landing/assets/images/product-images/product-image1.jpg') }}"
                                                            src="{{ asset('landing/assets/images/product-images/product-image1.jpg') }}"
                                                            alt="image" title="product">
                                                        <!-- End image -->
                                                        <!-- Hover image -->
                                                        <img class="hover blur-up lazyload"
                                                            data-src="{{ asset('landing/assets/images/product-images/product-image1-1.jpg') }}"
                                                            src="{{ asset('landing/assets/images/product-images/product-image1-1.jpg') }}"
                                                            alt="image" title="product">
                                                        <!-- End hover image -->
                                                        <!-- product label -->
                                                ...
                                                <div class="product-details text-center">
                                                    ...
                                                    <ul class="swatches">
                                                        <li class="swatch medium rounded"><img
                                                                src="{{ asset('landing/assets/images/product-images/variant1.jpg') }}"
                                                                alt="image" /></li>
                                                        <li class="swatch medium rounded"><img
                                                                src="{{ asset('landing/assets/images/product-images/variant2.jpg') }}"
                                                                alt="image" /></li>
                                                        <li class="swatch medium rounded"><img
                                                                src="{{ asset('landing/assets/images/product-images/variant3.jpg') }}"
                                                                alt="image" /></li>
                                                        <li class="swatch medium rounded"><img
                                                                src="{{ asset('landing/assets/images/product-images/variant4.jpg') }}"
                                                                alt="image" /></li>
                                                        <li class="swatch medium rounded"><img
                                                                src="{{ asset('landing/assets/images/product-images/variant5.jpg') }}"
                                                                alt="image" /></li>
                                                        <li class="swatch medium rounded"><img
                                                                src="{{ asset('landing/assets/images/product-images/variant6.jpg') }}"
                                                                alt="image" /></li>
                                                    </ul>
                                                    <!-- End Variant -->
                                                </div>
