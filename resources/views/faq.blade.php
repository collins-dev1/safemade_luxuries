        	...
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                	<div id="accordionExample">
                        ...
                        <div class="faq-body">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">What payment methods do you accept?</h4>
                            <div id="collapseOne" class="collapse panel-content" data-parent="#accordionExample">We accept major credit/debit cards, bank transfers, PayPal, and mobile payment options (depending on your country).</div>
                        </div>
                        <div class="faq-body">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Is my payment information secure?</h4>
                            <div id="collapseTwo" class="collapse panel-content">Absolutely. Our website uses SSL encryption and secure payment gateways to ensure your data is always safe.</div>
                        </div>
                        <div class="faq-body">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Can I return or exchange a product?</h4>
                            <div class="panel-content collapse" id="collapseThree">Yes, we accept returns and exchanges within 7–14 days of delivery for unused, undamaged items. Please see our Return Policy for full details.</div>
                        </div>
                        <div class="faq-body">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">What should I do if I received a wrong or damaged item?</h4>
                            <div class="panel-content collapse" id="collapseSeven">We're sorry! Please contact us within 48 hours of delivery with a photo of the item, and we’ll replace it at no extra cost.</div>
                        </div>
                        <h2 class="title h2">Other Resources</h2>
                        <div class="faq-body">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour"> What if an item is out of stock?</h4>
                            <div class="panel-content collapse" id="collapseFour"> If an item is out of stock, you can click “Notify Me” to get an alert when it’s back. You can also contact customer service for similar suggestions.</div>
                        </div>
                        <div class="faq-body">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Do you restock popular items?</h4>
                            <div class="panel-content collapse" id="collapseFive">Yes, we frequently restock high-demand items. Follow us on social media or subscribe to our newsletter for updates.</div>
                        </div>
                        <div class="faq-body">
                            <h4 class="panel-title" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">How can I contact customer service?</h4>
                            <div class="panel-content collapse" id="collapseSix"> You can reach us via our Contact Us page, live chat, or email at support@yourstore.com. Our support hours are Monday–Friday, 8 AM–6 PM.</div>
                        </div>
                    </div>
               	</div>
            </div>
