            ...
            <div class="container">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                        <div class="text-center mb-4">
                            ...
                            <div class="rte-setting">
                                ...
                                <p>At Safemade Luxuries, we specialize in offering a beautifully curated collection of
                                    women’s hair ties
                                    designed for every hair type, occasion, and personal style. From elegant silk
                                    scrunchies to trendy
                                    spiral coils and everyday elastic bands, our hair accessories are crafted with
                                    comfort, durability,
                                    and beauty in mind.
                                </p>
                            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload"
                            data-src="{{ asset('landing/assets/images/about4.jpg') }}"
                            src="{{ asset('landing/assets/images/about4.jpg') }}" alt="About Us" /></div>
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload"
                            data-src="{{ asset('landing/assets/images/about5.jpg') }}"
                            src="{{ asset('landing/assets/images/about5.jpg') }}" alt="About Us" /></div>
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload"
                            data-src="{{ asset('landing/assets/images/about6.jpg') }}"
                            src="{{ asset('landing/assets/images/about6.jpg') }}" alt="About Us" /></div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <h2>WE ALWAYS THE BEST</h2>
                        <p>Whether you're styling a casual ponytail, a sleek bun, or looking for a pop of color to
                            complete your
                            outfit, we’ve got you covered. Our hair ties come in a wide variety of colors, materials,
                            and
                            designs—perfect for workouts, office days, formal events, or just lounging at home.</p>
                        <p>We believe that your hair deserves both style and care, which is why our products are gentle
                            on your
                            strands while still providing a secure hold. Explore our collection and find the perfect
                            hair tie that
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 mb-4">
                        ...
                        <div class="rte-setting">
                            <p><strong>Discover a world where fashion meets function! Our women’s hair ties are more
                                    than just
                                    accessories — they’re everyday essentials designed to elevate your style and protect
                                    your hair. From
                                    soft satin scrunchies to strong no-pull elastics, each piece is made with love and
                                    care to suit every
                                    mood and outfit.</strong></p>
                            <p>Your hair deserves to be styled, not stressed. Our collection of premium hair ties offers
                                secure hold
                                without breakage or creases. Whether you're headed to the gym, office, or a night out,
                                our ties give you
                                all-day comfort and style.</p>
                            <p></p>
                            <p>Small details make a big difference. Our hair ties come in luxurious fabrics like silk,
                                velvet, cotton,
                                and more—crafted to be as beautiful as they are functional. Add a touch of class to your
                                ponytail or bun
